    ...
    <main class="flex-1 flex items-center justify-center p-6 w-full relative">
        ...
        <div class="max-w-md w-full">
            <div class="bg-white/80 dark:bg-zinc-800/60 rounded-3xl shadow-xl hover:shadow-2xl border border-zinc-100 dark:border-zinc-700/30 p-8 backdrop-blur-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <?php if($message): ?>
                    <div class="mb-6 p-3.5 rounded-2xl bg-pink-50 dark:bg-pink-950/30 text-pink-500 border border-pink-100 dark:border-pink-950/50 text-center font-bold text-xs tracking-wide animate-pulse">
                        <?= $message ?>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST" class="space-y-5">
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-[11px] font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 pl-1">Your Name</label>
                ...
                <div class="text-center mt-6 pt-4 border-t border-zinc-100 dark:border-zinc-700/50">
                    <p class="text-xs font-semibold text-zinc-400 dark:text-zinc-500">
                        ...
                        <a href="darling.php" class="text-pink-500 hover:text-pink-600 font-bold ml-1 transition-colors">Login</a>
                    </p>
                </div>
